 ...
 */
class Coordinacion extends \Proyecto\PrincipalBundle\Entity\Coordinacion implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'nombre', 'coordinador');
    }
